                    ...
                    <div class="card bg-base-100 shadow-xl">
                        <div class="card-body">
                            <div class="max-w-2xl mb-6">
                                <h1
                                    class="text-4xl md:text-5xl font-cinzel font-bold italic uppercase text-secondary mb-2">
                                    Create Account
                                </h1>
                            ...
                            <form @submit.prevent="handleRegister" class="space-y-6">
                                ...
                                <div class="form-control">
                                    <label class="input w-full floating-label"
                                        ...
                                        <input class="text-base" type="email" name="email" v-model="formData.email"
                                            ...
                                            autocomplete="email" required :disabled="isSubmitting" />
                                    </label>
                                ...
                                <div class="form-control">
                                    <label class="input w-full floating-label"
                                        ...
                                        <input class="text-base" type="text" name="username" v-model="formData.username"
                                            @blur="touched.username = true" placeholder="Choose a username"
                                            autocomplete="username" required :disabled="isSubmitting" />
                                    </label>
                                    <div v-if="touched.username && errors.username" class="text-error mt-2" role="alert"
                                        aria-live="assertive">
                                        {{ errors.username }}
                                    </div>
                                </div>
                                ...
                                <div class="form-control">
                                    <label class="input w-full floating-label"
                                        ...
                                        <input class="text-base" :type="showPassword ? 'text' : 'password'"
                                            ...
                                            placeholder="Enter your password" autocomplete="new-password" required :disabled="isSubmitting" />
                                ...
                                <div class="form-control">
                                    <label class="input w-full floating-label"
                                        ...
                                        <input class="text-base" :type="showConfirmPassword ? 'text' : 'password'"
                                            name="confirmPassword" v-model="formData.confirmPassword"
                                            @blur="touched.confirmPassword = true" placeholder="Confirm your password"
                                            autocomplete="new-password" required :disabled="isSubmitting" />
                                        <button type="button" @click="showConfirmPassword = !showConfirmPassword"
                                            class="opacity-50 hover:opacity-100 transition-opacity"
                                            aria-label="Toggle password visibility">
                                            <svg v-if="!showConfirmPassword" class="h-[1em]"
                                    ...
                                    <div v-if="touched.confirmPassword && errors.confirmPassword"
                                ...
                                <div class="form-control">
                                    <label class="label cursor-pointer justify-start gap-4">
                                        <input type="checkbox" class="checkbox checkbox-primary"
                                            v-model="formData.acceptTerms" required :disabled="isSubmitting" />
