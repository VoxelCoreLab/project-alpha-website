<template>
        ...
        <div class="">
            ...
            <div class="">
                <div class="grid grid-flow-col gap-4">
                    ...
                    <a href="https://www.youtube.com/@ShadowInfectionGame" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                    ...
                    <a href="https://www.tiktok.com/@shadowinfection" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            class="fill-current">
                            <path
    ...
    -->
        <aside>
            <p>Copyright © {{ new Date().getFullYear() }} - All right reserved by Voxel Core Lab GmbH</p>
        </aside>
    </footer>
</template>
